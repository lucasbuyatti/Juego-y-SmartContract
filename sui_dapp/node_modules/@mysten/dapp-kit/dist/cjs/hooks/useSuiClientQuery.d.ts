...
export declare function getSuiClientQuery<T extends keyof SuiRpcMethods>({ client, network, method, params, options, }: GetSuiClientQueryOptions<T>): import("@tanstack/react-query").OmitKeyof<UseQueryOptions<SuiRpcMethods[T]["result"], Error, SuiRpcMethods[T]["result"], import("@tanstack/react-query").QueryKey>, "queryFn"> & {
    queryFn?: import("@tanstack/react-query").QueryFunction<SuiRpcMethods[T]["result"], import("@tanstack/react-query").QueryKey, never> | undefined;
} & {
