...
prepareBuild_fn = async function(options) {
  ...
  await __privateMethod3(this, _Transaction_instances, runPlugins_fn).call(this, [...__privateGet3(this, _buildPlugins), resolveTransactionData], options);
};
...
getUsedObjects_fn = async function(transaction) {
  ...
  await transaction.prepareForSerialization({ client: __privateGet4(this, _client2) });
  return usedObjects;
};
execute_fn = async function(transaction, usedObjects, options) {
  ...
  let gasCoin;
  try {
    transaction.setSenderIfNotSet(__privateGet4(this, _signer2).toSuiAddress());
    await __privateGet4(this, _buildQueue).runTask(async () => {
      ...
      transaction.setGasBudgetIfNotSet(__privateGet4(this, _defaultGasBudget2));
      ...
      await __privateGet4(this, _cache3).buildTransaction({ transaction, onlyTransactionKind: true });
    });
    const bytes = await transaction.build({ client: __privateGet4(this, _client2) });
    const { signature } = await __privateGet4(this, _signer2).signTransaction(bytes);
    const results = await __privateGet4(this, _cache3).executeTransaction({
      transaction: bytes,
      signature,
      options: {
        ...options,
    ...
    if (gasCoin && gasUsed && gasResult.owner === __privateGet4(this, _signer2).toSuiAddress()) {
      ...
      if (!usesGasCoin && gasCoin.balance >= __privateGet4(this, _minimumCoinBalance)) {
        __privateGet4(this, _coinPool).push({
        ...
        if (!__privateGet4(this, _sourceCoins)) {
          __privateSet4(this, _sourceCoins, /* @__PURE__ */ new Map());
        }
        __privateGet4(this, _sourceCoins).set(gasResult.ref.objectId, gasResult.ref);
      }
    }
    ...
    if (gasCoin) {
      ...
      __privateGet4(this, _sourceCoins).set(gasCoin.id, null);
    }
    await __privateMethod4(this, _ParallelTransactionExecutor_instances, updateCache_fn).call(this, async () => {
      await Promise.all([
        __privateGet4(this, _cache3).cache.deleteObjects([...usedObjects]),
    ...
    usedObjects.forEach((objectId) => {
      const queue = __privateGet4(this, _objectIdQueues).get(objectId);
      if (queue && queue.length > 0) {
        queue.shift()();
      } else if (queue) {
        __privateGet4(this, _objectIdQueues).delete(objectId);
      }
    });
    __privateWrapper2(this, _pendingTransactions)._--;
  }
...
updateCache_fn = async function(fn) {
  if (__privateGet4(this, _cacheLock)) {
    await __privateGet4(this, _cacheLock);
  }
...
waitForLastDigest_fn = async function() {
  const digest = __privateGet4(this, _lastDigest2);
  if (digest) {
    __privateSet4(this, _lastDigest2, null);
    await __privateGet4(this, _client2).waitForTransaction({ digest });
  }
};
getGasCoin_fn = async function() {
  if (__privateGet4(this, _coinPool).length === 0 && __privateGet4(this, _pendingTransactions) <= __privateGet4(this, _maxPoolSize)) {
    await __privateMethod4(this, _ParallelTransactionExecutor_instances, refillCoinPool_fn).call(this);
  }
  if (__privateGet4(this, _coinPool).length === 0) {
    throw new Error("No coins available");
  }
  const coin = __privateGet4(this, _coinPool).shift();
  return coin;
};
getGasPrice_fn = async function() {
  const remaining = __privateGet4(this, _gasPrice) ? __privateGet4(this, _gasPrice).expiration - __privateGet4(this, _epochBoundaryWindow) - Date.now() : 0;
  if (remaining > 0) {
    return __privateGet4(this, _gasPrice).price;
  }
  if (__privateGet4(this, _gasPrice)) {
    const timeToNextEpoch = Math.max(
      __privateGet4(this, _gasPrice).expiration + __privateGet4(this, _epochBoundaryWindow) - Date.now(),
      1e3
    );
    await new Promise((resolve) => setTimeout(resolve, timeToNextEpoch));
  }
  const state = await __privateGet4(this, _client2).getLatestSuiSystemState();
...
refillCoinPool_fn = async function() {
  ...
  const batchSize = Math.min(
    __privateGet4(this, _coinBatchSize),
    __privateGet4(this, _maxPoolSize) - (__privateGet4(this, _coinPool).length + __privateGet4(this, _pendingTransactions)) + 1
  );
  if (batchSize === 0) {
    return;
  }
  const txb = new Transaction();
  const address = __privateGet4(this, _signer2).toSuiAddress();
  txb.setSender(address);
  if (__privateGet4(this, _sourceCoins)) {
    const refs = [];
    const ids = [];
    for (const [id, ref] of __privateGet4(this, _sourceCoins)) {
      if (ref) {
        refs.push(ref);
      } else {
        ids.push(id);
    ...
    if (ids.length > 0) {
      const coins = await __privateGet4(this, _client2).multiGetObjects({
        ids
      });
      refs.push(
  ...
  const amounts = new Array(batchSize).fill(__privateGet4(this, _initialCoinBalance));
  ...
  const result = await __privateGet4(this, _client2).signAndExecuteTransaction({
    transaction: txb,
    signer: __privateGet4(this, _signer2),
    options: {
      showRawEffects: true
    }
  });
  ...
  (_a = effects.V2) == null ? void 0 : _a.changedObjects.forEach(([id, { outputState }], i) => {
    ...
    __privateGet4(this, _coinPool).push({
      ...
      balance: BigInt(__privateGet4(this, _initialCoinBalance))
    });
  });
  if (!__privateGet4(this, _sourceCoins)) {
    __privateSet4(this, _sourceCoins, /* @__PURE__ */ new Map());
  ...
  __privateGet4(this, _sourceCoins).set(gasObject.objectId, gasObject);
  await __privateGet4(this, _client2).waitForTransaction({ digest: result.digest });
};
...
//# sourceMappingURL=chunk-C5GDXS4U.js.map
